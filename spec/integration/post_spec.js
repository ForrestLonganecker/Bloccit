    ...
    describe("guest preforming CRUD actions for Post", () => {
        ...
        describe("GET /topics/:topicId/posts/:id", () => {
            it("should render a view with the selected post", (done) => {
                request.get(`${base}/${this.topic.id}/posts/${this.originalPost.id}`, (err, res, body) => {
                    expect(err).toBeNull();
        ...
        describe("GET /topics/:topicId/posts/:id/edit", () => {
            it("should not render a view with an edit post form", (done) => {
                request.get(`${base}/${this.topic.id}/posts/${this.originalPost.id}/edit`, (err, res, body) => {
                    expect(err).toBeNull();
        ...
        describe("POST /topics/:topicId/posts/:id/destroy", () => {
            it("should not delete the post with the associated ID", (done) => {
                ...
                .then((posts) => {
                    ...
                    request.post(`${base}/${this.topic.id}/posts/${this.originalPost.id}/destroy`, (err, res, body) => {
                        Post.all()
                        .then((posts) => {
    ...
    describe("member user performing CRUD actions for Post", () => {
        ...
        describe("GET /topics/:topicId/posts/:id/edit", () => {
            it("if owner, should render a view with an edit post form", (done) => {
                request.get(`${base}/${this.topic.id}/posts/${this.userPost.id}/edit`, (err, res, body) => {
                    expect(err).toBeNull();
        ...
        describe("POST /topics/:topicId/posts/:id/destroy", () => {
            it("if owner, should delete the post with the associated ID", (done) => {
                ...
                .then((posts) => {
                    ...
                    request.post(`${base}/${this.topic.id}/posts/${this.userPost.id}/destroy`, (err, res, body) => {
                        Post.all()
                        .then((posts) => {
                            expect(err).toBeNull();
